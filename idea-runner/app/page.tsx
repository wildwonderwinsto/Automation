...
import { Note, Scene, SceneTiming, CaptionStyle, WordTiming, DEFAULT_CAPTION_STYLE } from "./types";
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[200px_1fr_320px]">
          ...
          {currentStageId === 5 && (
            <CaptionsStage
              ...
              onSceneTimingsGenerated={setSceneTimings}
              wordTimings={wordTimings}
              onWordTimingsGenerated={setWordTimings}
